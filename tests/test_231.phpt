--TEST--
IBM-DB2: db2_field_type() - by name
--SKIPIF--
...
{
   print $i . ":" . db2_field_type($result,db2_field_name($result,$i)) . "\n";
}
print "\n-----\n";
for ($i=0; $i < db2_num_fields($result2); $i++) 
{
   print $i . ":" . db2_field_type($result2,db2_field_name($result2,$i)) . "\n";
}
print "\n-----\n";
for ($i=0; $i < db2_num_fields($result3); $i++) 
{
   print $i . ":" . db2_field_type($result3,db2_field_name($result3,$i)) . "\n";
}
print "\n-----\n";
